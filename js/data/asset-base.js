 ...
 * --------------------------------------------------------------------------
 * Where the baked binary/geo assets (assets/*.bin, *.pmtiles, *.json) are
 * served from.
 *
 ...
 *     (Cloudflare R2 at https://assets.terragotcha.com), because the big files
 *     — planet-z9.pmtiles (~1.5 GB) and world-mesh.bin (~31 MB) — exceed
 *     Cloudflare Pages' 25 MiB/file limit and must come from R2.
 *
